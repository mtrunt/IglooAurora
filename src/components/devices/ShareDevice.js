...
class ShareDevice extends React.Component {
  state = {
    menuOpen: false,
    addAdminOpen: false,
          ...
          >
            <li key="Owner">
              <ul style={{ padding: "0" }}>
                ...
                <ListItem key={this.props.device.owner.id}>
                  <ListItemAvatar>
                    <Avatar
                      style={{
                        backgroundColor: this.props.device.owner
                          .profileIconColor,
                      }}
                    >
                      {this.getInitials(this.props.device.owner.fullName)}
                    </Avatar>
                  </ListItemAvatar>
                  <ListItemText
                    primary={
                      this.props.userData.user.email ===
                        this.props.device.owner.email
                        ? "You"
                        : this.props.device.owner.fullName
                    }
                    secondary={
                      this.props.userData.user.email ===
                        this.props.device.owner.email
            ...
            {!((this.props.device.myRole === "EDITOR" || this.props.device.myRole === "SPECTATOR") && !this.props.device.admins[0]) && <li key="Admins">
              <ul style={{ padding: "0" }}>
                <ListSubheader
                  style={{ backgroundColor: "white" }}
                  className="notSelectable defaultCursor"
                ...
                {this.props.device.admins.map(item => (
                ...
                {(this.props.device.myRole === "ADMIN" || this.props.device.myRole === "OWNER") && <ListItem
                  button
                  onClick={() =>
                    this.setState({
                      addAdminOpen: true,
            ...
            {!((this.props.device.myRole === "SPECTATOR") && !this.props.device.admins[0]) && <li key="Editors">
              <ul style={{ padding: "0" }}>
                <ListSubheader style={{ backgroundColor: "white" }}>
                  Editors
                </ListSubheader>
                {this.props.device.editors.map(item => (
                  <ListItem key={item.id}>
                    <ListItemAvatar>
                      <Avatar
                        style={{
            ...
            {!((this.props.device.myRole === "EDITOR") && !this.props.device.admins[0]) && <li key="Spectators">
              <ul style={{ padding: "0" }}>
                <ListSubheader style={{ backgroundColor: "white" }}>
                  Spectators
                </ListSubheader>
                {this.props.device.spectators.map(item => (
                  <ListItem key={item.id}>
                    <ListItemAvatar>
                      <Avatar
                        style={{
...
export default graphql(
  ...
  graphql(
    gql`
      mutation InviteUser($email: String!, $deviceId: ID!, $role: Role!) {
        shareDevice(email: $email, deviceId: $deviceId, role: $role) {
          id
        }
      }
    `,
