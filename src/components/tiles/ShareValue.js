...
import createMuiTheme from "@amterial-ui/core/styles/createMuiTheme"
        ...
        <React.Fragment>
          ...
          >
            ...
            >
              ...
              {!(
                (this.props.value.myRole === "EDITOR" ||
                  this.props.value.myRole === "SPECTATOR") &&
                !this.props.value.admins[0]
              ) && (
                <li key="Admins">
                  <ul style={{ padding: "0" }}>
                    <ListSubheader
                    ...
                    {(this.props.value.myRole === "ADMIN" ||
                      this.props.value.myRole === "OWNER") && (
                      <ListItem
                        button
                        onClick={() =>
                          this.setState({
